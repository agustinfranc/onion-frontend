...
!(function (a, b) {
      ...
      map(a, b, c) {
        ...
        if (s(a))
          for (d = a.length; d > g; g++)
            (e = b(a[g], g, c)), e != null && h.push(e)
        else for (g in a) (e = b(a[g], g, c)), e != null && h.push(e)
        return f.apply([], h)
      },
      guid: 1,
      proxy(a, b) {
        ...
        return g !== n && g.nodeType === 9 && g.documentElement
          ? ((n = g),
            ...
            (d.find.CLASS =
              c.getElementsByClassName &&
              function (a, b) {
                return typeof b.getElementsByClassName !== 'undefined' && p
        ...
        pseudos: {
          ...
          contains: ha(function (a) {
            return (
              (a = a.replace(ba, ca)),
              function (b) {
                return (b.textContent || b.textContent || e(b)).includes(a)
              }
            )
          }),
          lang: ha(function (a) {
  ...
  ;(n.filter = function (a, b, c) {
    ...
    n.fn.extend({
      ...
      is(a) {
        return !!z(
          this,
          typeof a === 'string' && w.test(a) ? n(a) : a || [],
          !1
        ).length
      },
    })
    ...
    closest(a, b) {
      for (
        var c,
          ...
          e = this.length,
          f = [],
          g = w.test(a) || typeof a !== 'string' ? n(a, b || this.context) : 0;
        e > d;
        d++
      )
  ...
  ;(n.Callbacks = function (a) {
            ...
            (function d(b) {
              n.each(b, function (b, c) {
                n.isFunction(c)
                  ...
                  : c && c.length && n.type(c) !== 'string' && d(c)
              })
            })(arguments),
            c && !b && i()),
          this
    ...
    n.extend({
      ...
      when(a) {
        ...
        const d = c.length
        let f = d !== 1 || (a && n.isFunction(a.promise)) ? d : 0
  ...
  const M = function (a) {
    const b = n.noData[(a.nodeName + ' ').toLowerCase()]
  ...
  function Q(a) {
    let b
    for (b in a)
      if ((b !== 'data' || !n.isEmptyObject(a[b])) && b !== 'toJSON') return !1
    return !0
  }
  function R(a, b, d, e) {
    if (M(a)) {
      ...
      if (
        ...
        return (
          ...
          typeof b === 'string'
            ? ((f = g[b]), f == null && (f = g[n.camelCase(b)]))
            : (f = g),
          f
        )
    }
  ...
  function S(a, b, c) {
    if (M(a)) {
      ...
      const f = a.nodeType
      const g = f ? n.cache : a
      const h = f ? a[n.expando] : n.expando
      if (g[h]) {
    ...
    n.fn.extend({
      data(a, b) {
        ...
        if (void 0 === a) {
          if (
            this.length &&
            ((e = n.data(f)), f.nodeType === 1 && !n._data(f, 'parsedAttrs'))
          ) {
            c = g.length
            while (c--)
              g[c] &&
  ...
  const T = /[+-]?(?:\d*\.|)\d+(?:[eE][+-]?\d+|)/.source
  const U = new RegExp('^(?:([+-])=|)(' + T + ')([a-z%]*)$', 'i')
  ...
  function X(a, b, c, d) {
    ...
    let k = (n.cssNumber[b] || (j !== 'px' && +i)) && U.exec(n.css(a, b))
    if (k && k[3] !== j) {
      ;(j = j || k[3]), (c = c || []), (k = +i || 1)
  ...
  const Z = /^(?:checkbox|radio)$/i
  const $ = /<([\w:-]+)/
  const _ = /^$|\/(?:java|ecma)script/i
  const aa = /^\s+/
  const ba =
  ...
  function ja(a, b, c, d, e) {
    for (
      ...
      if (((g = a[r]), g || g === 0))
        if (n.type(g) === 'object') n.merge(q, g.nodeType ? [g] : g)
        else if (ga.test(g)) {
  ...
  const ka = /^(?:input|select|textarea)$/i
  const la = /^key/
  const ma = /^(?:mouse|pointer|contextmenu|drag|drop)|click/
  const na = /^(?:focusinfocus|focusoutblur)$/
  const oa = /^([^.]*)(?:\.(.+)|)/
  function pa() {
    return !0
  }
  ...
  ;(n.event = {
    ...
    trigger(b, c, e, f) {
      ...
      if (
        ...
        e.nodeType !== 3 &&
          ...
          (q.includes('.') && ((r = q.split('.')), (q = r.shift()), r.sort()),
          (h = !q.includes(':') && 'on' + q),
    ...
    dispatch(a) {
      ...
      const j = (n._data(this, 'events') || {})[a.type] || []
    ...
    handlers(a, b) {
      ...
      if (
        h &&
        i.nodeType &&
        (a.type !== 'click' || isNaN(a.button) || a.button < 1)
      )
  ...
  const ta = / jQuery\d+="(?:null|\d+)"/g
  const ua = new RegExp('<(?:' + ba + ')[\\s/>]', 'i')
  const va = /<(?!area|br|col|embed|hr|img|input|link|meta|param)(([\w:-]+)[^>]*)\/>/gi
  const wa = /<script|<style|<link/i
  const xa = /checked\s*(?:[^=]|=\s*.checked.)/i
  const ya = /^true\/(.*)/
  const za = /^\s*<!(?:\[CDATA\[|--)|(?:\]\]|--)>\s*$/g
  const Aa = ca(d)
  const Ba = Aa.appendChild(d.createElement('div'))
  function Ca(a, b) {
  ...
  function Ia(a, b, c) {
    for (var d, e = b ? n.filter(b, a) : a, f = 0; (d = e[f]) != null; f++)
      c || d.nodeType !== 1 || n.cleanData(ea(d)),
        d.parentNode &&
  ...
  n.extend({
    ...
    clone(a, b, c) {
      ...
      if (
        ...
        for (d = ea(f), h = ea(a), g = 0; (e = h[g]) != null; ++g)
          d[g] && Ga(e, d[g])
      if (b)
        if (c)
          for (h = h || ea(a), d = d || ea(f), g = 0; (e = h[g]) != null; g++)
            Fa(e, d[g])
        else Fa(a, f)
      return (
        (d = ea(f, 'script')),
    ...
    cleanData(a, b) {
      for (
        ...
        if ((b || M(d)) && ((f = d[i]), (g = f && j[f]))) {
          ...
          j[f] &&
            (delete j[f],
            k || typeof d.removeAttribute === 'undefined'
              ? (d[i] = void 0)
              : d.removeAttribute(i),
            c.push(f))
        }
    ...
    n.fn.extend({
      ...
      empty() {
        for (var a, b = 0; (a = this[b]) != null; b++) {
          a.nodeType === 1 && n.cleanData(ea(a, !1))
      ...
      html(a) {
        return Y(
          ...
          function (a) {
            ...
            const d = this.length
            if (void 0 === a)
              return b.nodeType === 1 ? b.innerHTML.replace(ta, '') : void 0
            if (
              typeof a === 'string' &&
              !wa.test(a) &&
  ...
  let Ja
  const Ka = { HTML: 'block', BODY: 'block' }
  function La(a, b) {
  ...
  const Na = /^margin/
  const Oa = new RegExp('^(' + T + ')(?!px)[a-z%]+$', 'i')
  const Pa = function (a, b, c, d) {
    let e
    let f
    const g = {}
      ...
      function k() {
        ...
        m.appendChild(i),
          ...
          a.getComputedStyle &&
            ...
            (b = (l || {}).top !== '1%'),
            (h = (l || {}).marginLeft === '2px'),
            (e = (l || { width: '4px' }).width === '4px'),
            (j.style.marginRight = '50%'),
            (c = (l || { marginRight: '4px' }).marginRight === '4px'),
  ...
  const Va = /alpha\([^)]*\)/i
  const Wa = /opacity\s*=\s*([^)]*)/i
  const Xa = /^(none|table(?!-c[ea]).+)/
  const Ya = new RegExp('^(' + T + ')(.*)$', 'i')
  const Za = { position: 'absolute', visibility: 'hidden', display: 'block' }
  const $a = { letterSpacing: '0', fontWeight: '400' }
  const _a = ['Webkit', 'O', 'Moz', 'ms']
  const ab = d.createElement('div').style
  function bb(a) {
    if (a in ab) return a
  ...
  function eb(a, b, c, d, e) {
    for (
      ...
      c === 'margin' && (g += n.css(a, c + V[f], !0, e)),
        d
          ? (c === 'content' && (g -= n.css(a, 'padding' + V[f], !0, e)),
            c !== 'margin' && (g -= n.css(a, 'border' + V[f] + 'Width', !0, e)))
  ...
  function fb(a, b, c) {
    ...
    const f = Ra(a)
    const g = l.boxSizing && n.css(a, 'boxSizing', !1, f) === 'border-box'
    if (e <= 0 || e == null) {
      if (
        ((e = Sa(a, b, f)),
  ...
  n.extend({
    ...
    n.each(['height', 'width'], function (a, b) {
      n.cssHooks[b] = {
        get(a, c, d) {
          return c
            ? Xa.test(n.css(a, 'display')) && a.offsetWidth === 0
              ? Pa(a, Za, function () {
                  return fb(a, b, d)
                })
              : fb(a, b, d)
          ...
          return db(
            ...
            d
              ? eb(
                  ...
                  b,
                  d,
                  l.boxSizing && n.css(a, 'boxSizing', !1, e) === 'border-box',
                  e
                )
              : 0
          )
    ...
    l.opacity ||
      (n.cssHooks.opacity = {
        ...
        set(a, b) {
          ...
          const e = n.isNumeric(b) ? 'alpha(opacity=' + 100 * b + ')' : ''
  ...
  ;(n.Tween = gb),
    (gb.prototype = {
      ...
      cur() {
        const a = gb.propHooks[this.prop]
        return a && a.get ? a.get(this) : gb.propHooks._default.get(this)
      },
      run(a) {
        let b
        const c = gb.propHooks[this.prop]
        return (
  ...
  function ob(a, b, c) {
    ...
    const o = {}
    const p = a.style
    let q = a.nodeType && W(a)
    let r = n._data(a, 'fxshow')
    c.queue ||
      ...
      a.nodeType === 1 &&
        ...
        k === 'inline' &&
          n.css(a, 'float') === 'none' &&
          (l.inlineBlockNeedsLayout && Ma(a.nodeName) !== 'inline'
            ? (p.zoom = 1)
    ...
    if (n.isEmptyObject(o))
      (j === 'none' ? Ma(a.nodeName) : j) === 'inline' && (p.display = j)
    else {
  ...
  function qb(a, b, c) {
    ...
    let e
    let f = 0
    const g = qb.prefilters.length
    const h = n.Deferred().always(function () {
      delete i.elem
    })
    var i = function () {
      if (e) return !1
  ...
  ;(n.Animation = n.extend(qb, {
    ...
    (function () {
      ...
      const e = d.createElement('select')
      const f = e.appendChild(d.createElement('option'))
  ...
  let tb
  let ub
  const vb = n.expr.attrHandle
  const wb = /^(?:checked|selected)$/i
  const xb = l.getSetAttribute
  const yb = l.input
  n.fn.extend({
    attr(a, b) {
          ...
          return typeof a.getAttribute === 'undefined'
            ...
            : ((f === 1 && n.isXMLDoc(a)) ||
              ...
              void 0 !== c
                ...
                ? d
                : ((d = n.find.attr(a, b)), d == null ? void 0 : d))
      },
      attrHooks: {
        type: {
          set(a, b) {
  ...
  const zb = /^(?:input|select|textarea|button|object)$/i
  const Ab = /^(?:a|area)$/i
  n.fn.extend({
    prop(a, b) {
    ...
    toggleClass(a, b) {
      ...
      return typeof b === 'boolean' && c === 'string'
        ...
        : this.each(function () {
            ...
            } else (void 0 !== a && c !== 'boolean') || ((b = Cb(this)), b && n._data(this, '__className__', b), n.attr(this, 'class', b || a === !1 ? '' : n._data(this, '__className__') || ''))
          })
    },
    hasClass(a) {
      let b
  ...
  const Ib = /([?&])_=[^&]*/
  const Jb = /^(.*?):[ \t]*([^\r\n]*)\r?$/gm
  const Kb = /^(?:about|app|app-storage|.+-extension|file|res|widget):$/
  const Lb = /^(?:GET|HEAD)$/
  const Mb = /^\/\//
  const Nb = /^([\w.+-]+:)(?:\/\/(?:[^\/?#]*@|)([^\/?#:]*)(?::(\d+)|)|)/
  const Ob = {}
  ...
  const Qb = '*/'.concat('*')
  const Rb = Db.href
  const Sb = Nb.exec(Rb.toLowerCase()) || []
  function Tb(a) {
    return function (b, c) {
  ...
  n.extend({
    ...
    ajax(b, c) {
      ...
      let j
      let k
      const l = n.ajaxSetup({}, c)
      const m = l.context || l
      const o = l.context && (m.nodeType || m.jquery) ? n(m) : n.event
      const p = n.Deferred()
      const q = n.Callbacks('once memory')
      let r = l.statusCode || {}
      const s = {}
      const t = {}
      let u = 0
      ...
      if (l.beforeSend && (l.beforeSend.call(m, w, l) === !1 || u === 2))
        return w.abort()
      v = 'abort'
      for (e in { success: 1, error: 1, complete: 1 }) w[e](l[e])
      if ((j = Ub(Pb, l, c, w))) {
        if (((w.readyState = 1), i && o.trigger('ajaxSend', [w, l]), u === 2))
          return w
        l.async &&
          l.timeout > 0 &&
    ...
    n.fn.extend({
      wrapAll(a) {
        ...
        if (this[0]) {
          const b = n(a, this[0].ownerDocument).eq(0).clone(!0)
  ...
  function Zb(a) {
    ...
    while (a && a.nodeType === 1) {
      if (Yb(a) === 'none' || a.type === 'hidden') return !0
      a = a.parentNode
    }
    return !1
  }
  ...
  const _b = /\[\]$/
  const ac = /\r?\n/g
  const bc = /^(?:submit|button|image|reset|file)$/i
  const cc = /^(?:input|select|textarea|keygen)/i
  function dc(a, b, c, d) {
    let e
    if (n.isArray(b))
  ...
  let ec = 0
  const fc = {}
  let gc = n.ajaxSettings.xhr()
  a.attachEvent &&
    a.attachEvent('onunload', function () {
      for (const a in fc) fc[a](void 0, !0)
    }),
  ...
  n.ajaxSetup({
    ...
    n.ajaxTransport('script', function (a) {
      if (a.crossDomain) {
        let b
        const c = d.head || n('head')[0] || d.documentElement
        return {
          send(e, f) {
  ...
  n.ajaxSetup({
    ...
    (n.parseHTML = function (a, b, c) {
      ...
      typeof b === 'boolean' && ((c = b), (b = !1)), (b = b || d)
      let e = x.exec(a)
      const f = !c && []
      return e
        ? [b.createElement(e[1])]
  ...
  ;(n.fn.load = function (a, b, c) {
    if (typeof a !== 'string' && lc) return lc.apply(this, arguments)
    let d
    let e
    let f
    const g = this
