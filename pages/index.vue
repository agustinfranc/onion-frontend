<template>
  <div>
    ...
    <!-- slider_area_start -->
    <div id="slider_area" class="slider_area">
    ...
    <!-- service_area_2  -->
    <div id="service_area_2" class="service_area_2">
      <div class="container">
        <div class="row align-items-center">
          <div class="col-xl-12">
            <div
          ...
          >
            <div class="man_thumb">
              <img src="img/ilstrator_img/qr_hand.png" alt />
            </div>
          </div>
    ...
    <!-- prising_area  -->
    <div id="prising_area" class="prising_area">
      <div class="container">
        <div class="row">
          <div class="col-xl-12">
            <div
            ...
            >
              <h3>Elegí tu plan.</h3>
              <p>
                No vas a pagar comisiones por tus ventas,
                <br />sólo una suscripción.
              </p>
            </div>
          </div>
        </div>
          ...
          <div class="col-12">
            ...
            >
              <div class="text-center">
                <h3>Contactanos!</h3>
                <p>
                  Contactate con nosotros para trabajar juntos y
                  <br />optimizar la tecnología de tu negocio
                </p>
              </div>
            </div>
          </div>
        ...
        <div class="container">
          <div class="row">
            ...
            <div class="col-xl-4 offset-xl-1 col-md-6 col-lg-2">
              <div class="footer_widget">
                <h3 class="footer_title">Links Utiles</h3>
                <ul>
                  <li>
                    <a href="#prising_area">Planes</a>
                  </li>
