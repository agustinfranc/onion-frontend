...
!(function (t, e) {
  ...
  const P = (function (t) {
      ...
      getSelectorFromElement(e) {
        ...
        ;(i && i !== '#') || (i = e.getAttribute('href') || ''),
          i.charAt(0) === '#' &&
            ((n = i),
            (i = n =
              typeof t.escapeSelector === 'function'
    ...
    return (
      (e = (typeof window === 'undefined' || !window.QUnit) && {
        end: 'transitionend',
      }),
    ...
    (g = (function () {
      ...
      return (
        ...
        (e._getRootElement = function (t) {
          const e = P.getSelectorFromElement(t)
          let n = !1
  ...
  const j = (function (t) {
    ...
    const g = 'active'
    const p = 'slide'
    const m = 'carousel-item-right'
    const v = 'carousel-item-left'
    const E = 'carousel-item-next'
    const T = 'carousel-item-prev'
    const y = {
      ACTIVE: '.active',
    ...
    const C = (function () {
      ...
      return (
        ...
        (C._triggerSlideEvent = function (e, n) {
          ...
          const s = this._getItemIndex(t(this._element).find(y.ACTIVE_ITEM)[0])
        ...
        (C._slide = function (e, n) {
          ...
          let r
          const o = this
          const a = t(this._element).find(y.ACTIVE_ITEM)[0]
          const l = this._getItemIndex(a)
          const c = n || (a && this._getItemByDirection(e, a))
          const _ = this._getItemIndex(c)
        ...
        (o._dataApiClickHandler = function (e) {
          ...
          if (i) {
            const s = t(i)[0]
            if (s && t(s).hasClass(_)) {
              const a = r({}, t(s).data(), t(this).data())
  ...
  const H = (function (t) {
    ...
    const i = '.' + n
    const o = t.fn[e]
    const a = { toggle: !0, parent: '' }
    const l = { toggle: 'boolean', parent: '(string|element)' }
    const h = {
      SHOW: 'show' + i,
      SHOWN: 'shown' + i,
      HIDE: 'hide' + i,
    ...
    const m = (function () {
      function i(e, n) {
        ...
        for (let i = t(p.DATA_TOGGLE), s = 0; s < i.length; s++) {
          const r = i[s]
          const o = P.getSelectorFromElement(r)
          o !== null &&
      ...
      return (
        ...
        (i._jQueryInterface = function (e) {
          return this.each(function () {
            const s = t(this)
            let o = s.data(n)
            const l = r({}, a, s.data(), typeof e === 'object' && e)
            if (
    ...
    return (
      t(document).on(h.CLICK_DATA_API, p.DATA_TOGGLE, function (e) {
        ...
        const i = t(this)
        const s = P.getSelectorFromElement(this)
        t(s).each(function () {
          const e = t(this)
          const s = e.data(n) ? 'toggle' : i.data()
  ...
  const W = (function (t) {
    ...
    const _ = 'dropright'
    const g = 'dropleft'
    const p = 'dropdown-menu-right'
    const m = 'dropdown-menu-left'
    const v = 'position-static'
    const E = '[data-toggle="dropdown"]'
    const T = '.dropdown form'
    const y = '.dropdown-menu'
    const C = '.navbar-nav'
    const I = '.dropdown-menu .dropdown-item:not(.disabled)'
    const A = 'top-start'
    const b = 'top-end'
    const D = 'bottom-start'
    const S = 'bottom-end'
    const w = 'right-start'
    const N = 'left-start'
    const O = { offset: 0, flip: !0, boundary: 'scrollParent' }
    const k = {
      ...
      return (
        (l.toggle = function () {
          if (!this._element.disabled && !t(this._element).hasClass(u)) {
            ...
            const i = t(this._menu).hasClass(f)
            if ((a._clearMenus(), !i)) {
              const s = { relatedTarget: this._element }
              const r = t.Event(c.SHOW, s)
        ...
        (a._jQueryInterface = function (e) {
          return this.each(function () {
            ...
            if (
              (n ||
                ((n = new a(this, typeof e === 'object' ? e : null)),
                t(this).data(i, n)),
              typeof e === 'string')
            ) {
        ...
        (a._clearMenus = function (e) {
          if (!e || (e.which !== 3 && (e.type !== 'keyup' || e.which === 9)))
            for (let n = t.makeArray(t(E)), s = 0; s < n.length; s++) {
              const r = a._getParentFromElement(n[s])
              const o = t(n[s]).data(i)
              const l = { relatedTarget: n[s] }
              if (o) {
                const h = o._menu
                if (
                  t(r).hasClass(f) &&
        ...
        (a._getParentFromElement = function (e) {
          let n
          const i = P.getSelectorFromElement(e)
        ...
        (a._dataApiKeydownHandler = function (e) {
          if (
            ...
            const n = a._getParentFromElement(this)
            const i = t(n).hasClass(f)
            if (
  ...
  const M = (function (t) {
    ...
    const i = '.' + n
    const o = t.fn.modal
    const a = { backdrop: !0, keyboard: !0, focus: !0, show: !0 }
    const l = {
    ...
    const c = 'modal-scrollbar-measure'
    const u = 'modal-backdrop'
    const f = 'modal-open'
    const d = 'fade'
    const _ = 'show'
    const g = {
      ...
      return (
        ...
        (p.show = function (e) {
          ...
          if (!this._isTransitioning && !this._isShown) {
            ...
            const i = t.Event(h.SHOW, { relatedTarget: e })
            t(this._element).trigger(i),
              this._isShown ||
        ...
        (p._showElement = function (e) {
          const n = this
          const i = P.supportsTransitionEnd() && t(this._element).hasClass(d)
          ...
          const s = t.Event(h.SHOWN, { relatedTarget: e })
          const r = function () {
          ...
          i
            ? t(this._dialog).one(P.TRANSITION_END, r).emulateTransitionEnd(300)
            : r()
        }),
        ...
        (p._showBackdrop = function (e) {
          const n = this
          const i = t(this._element).hasClass(d) ? d : ''
        ...
        (p._setScrollbar = function () {
          ...
          if (this._isBodyOverflowing) {
            t(g.FIXED_CONTENT).each(function (n, i) {
              const s = t(i)[0].style.paddingRight
              ...
              t(g.STICKY_CONTENT).each(function (n, i) {
                const s = t(i)[0].style.marginRight
    ...
    return (
      t(document).on(h.CLICK_DATA_API, g.DATA_TOGGLE, function (e) {
        let i
        const s = this
        const o = P.getSelectorFromElement(this)
        o && (i = t(o)[0])
      ...
      return (
        ...
        (I.show = function () {
          ...
          if (this.isWithContent() && this._isEnabled) {
            ...
            const o = P.getUID(this.constructor.NAME)
            r.setAttribute('id', o),
        ...
        (I.hide = function (e) {
          ...
          const s = t.Event(this.constructor.Event.HIDE)
          const r = function () {
        ...
        (I._enter = function (e, n) {
          ...
          ;(n = n || t(e.currentTarget).data(i)) ||
            ...
            e && (n._activeTrigger[e.type === 'focusin' ? T : E] = !0),
        ...
        (I._leave = function (e, n) {
          ...
          ;(n = n || t(e.currentTarget).data(i)) ||
            ...
            t(e.currentTarget).data(i, n)),
            e && (n._activeTrigger[e.type === 'focusout' ? T : E] = !1),
  ...
  const x = (function (t) {
    ...
    const i = '.' + n
    const o = t.fn[e]
    const a = new RegExp('(^|\\s)bs-popover\\S+', 'g')
    const l = r({}, U.Default, {
      placement: 'right',
      trigger: 'click',
      content: '',
    ...
    const h = r({}, U.DefaultType, { content: '(string|element|function)' })
    const c = 'fade'
    const u = 'show'
    const f = '.popover-header'
    const d = '.popover-body'
    const _ = {
      HIDE: 'hide' + i,
      HIDDEN: 'hidden' + i,
      SHOW: 'show' + i,
  ...
  const K = (function (t) {
    const e = 'scrollspy'
    const n = 'bs.scrollspy'
    const i = '.' + n
    const o = t.fn[e]
    const a = { offset: 10, method: 'auto', target: '' }
    const l = { offset: 'number', method: 'string', target: '(string|element)' }
    const h = {
      ACTIVATE: 'activate' + i,
      SCROLL: 'scroll' + i,
      LOAD_DATA_API: 'load' + i + '.data-api',
    ...
    const g = (function () {
      ...
      return (
        (g.refresh = function () {
          const e = this
          const n = this._scrollElement === this._scrollElement.window ? d : _
          const i = this._config.method === 'auto' ? n : this._config.method
          const s = i === _ ? this._getScrollTop() : 0
          ;(this._offsets = []),
            (this._targets = []),
            ...
            t
              ...
              .map(function (e) {
                let n
                const r = P.getSelectorFromElement(e)
                if ((r && (n = t(r)[0]), n)) {
        ...
        (o._jQueryInterface = function (e) {
          return this.each(function () {
            ...
            if (
              (i ||
                ((i = new o(this, typeof e === 'object' && e)),
                t(this).data(n, i)),
              typeof e === 'string')
            ) {
              if (typeof i[e] === 'undefined')
  ...
  const V = (function (t) {
    ...
    const c = 'show'
    const u = '.dropdown'
    const f = '.nav, .list-group'
    const d = '.active'
    const _ = '> li > .active'
    const g = '[data-toggle="tab"], [data-toggle="pill"], [data-toggle="list"]'
    const p = '.dropdown-toggle'
    const m = '> .dropdown-menu .active'
    const v = (function () {
      function n(t) {
        this._element = t
      }
      ...
      return (
        (i.show = function () {
          ...
          if (
            ...
            let n
            let i
            const s = t(this._element).closest(f)[0]
            const o = P.getSelectorFromElement(this._element)
            if (s) {
              const h = s.nodeName === 'UL' ? _ : d
              i = (i = t.makeArray(t(s).find(h)))[i.length - 1]
            }
            const c = t.Event(r.HIDE, { relatedTarget: this._element })
            const u = t.Event(r.SHOW, { relatedTarget: i })
            if (
              (i && t(i).trigger(c),
              ...
              const g = function () {
                const n = t.Event(r.HIDDEN, { relatedTarget: e._element })
                const s = t.Event(r.SHOWN, { relatedTarget: i })
        ...
        (i._activate = function (e, n, i) {
          const s = this
          const r = (n.nodeName === 'UL' ? t(n).find(_) : t(n).children(d))[0]
          const o = i && P.supportsTransitionEnd() && r && t(r).hasClass(h)
          const a = function () {
        ...
        (n._jQueryInterface = function (i) {
          return this.each(function () {
            ...
            let r = s.data(e)
            if (
              (r || ((r = new n(this)), s.data(e, r)), typeof i === 'string')
            ) {
