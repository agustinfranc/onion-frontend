...
!(function (a) {
  ...
  const p = '.' + o
  const q = 'mfp-ready'
  const r = 'mfp-removing'
  const s = 'mfp-prevent-close'
  const t = function () {}
  const u = !!window.jQuery
  const v = a(window)
  const w = function (a, c) {
    b.ev.on(o + a + p, c)
  }
  ...
  ;(t.prototype = {
    ...
    open(c) {
      ...
      y('BeforeOpen'),
        ...
        (b.st.fixedBgPos === !1 ||
          (b.st.fixedBgPos === 'auto' && !b.fixedContentPos)) &&
    ...
    updateItemHTML() {
      ...
      const g = b['get' + d.charAt(0).toUpperCase() + d.slice(1)](
        c,
        b.currTemplate[d]
      )
      b.appendContent(g, d),
    ...
    _openClick(c, d, e) {
      ...
      if (
        f ||
        !(c.which === 2 || c.ctrlKey || c.metaKey || c.altKey || c.shiftKey)
      ) {
        const g =
          void 0 !== e.disableOn
            ? e.disableOn
            ...
            ? ((f += ' mfp-gallery'),
              ...
              w('BuildControls' + e, function () {
                if (b.items.length > 1 && c.arrows && !b.arrowLeft) {
                  ...
                  const e = (b.arrowLeft = a(
                    d.replace(/%title%/gi, c.tPrev).replace(/%dir%/gi, 'left')
                  ).addClass(s))
                  const f = (b.arrowRight = a(
