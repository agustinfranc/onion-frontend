...
;(gj.widget = function () {
  ...
  (gj.widget.prototype.createDoneHandler = function () {
    const a = this
    return function (b) {
      typeof b === 'string' && JSON && (b = JSON.parse(b)),
        gj[a.data('type')].methods.render(a, b)
    }
  }),
  (gj.widget.prototype.createErrorHandler = function () {
    return function (a) {
      a && a.statusText && a.statusText !== 'abort' && alert(a.statusText)
    }
  }),
  ...
  (gj.documentManager = {
    events: {},
    subscribeForEvent(a, b, c) {
      if (
        gj.documentManager.events[a] &&
        gj.documentManager.events[a].length !== 0
      ) {
    ...
    executeCallbacks(a) {
      const b = gj.documentManager.events[a.type]
      if (b) for (let c = 0; c < b.length; c++) b[c].callback(a)
    },
    unsubscribeForEvent(a, b) {
      let c = !1
      const d = gj.documentManager.events[a]
      if (d)
  ...
  (gj.core = {
    ...
    parseDate(a, b, c) {
      ...
      if (a && typeof a === 'string') {
        ...
        else if (a.includes('/Date(')) g = new Date(parseInt(a.substr(6), 10))
        else if (a) {
          for (
            f = b.split(/[\s,-\.\/\/\:]+/),
              e = a.split(/[\s]+/),
            ...
            ['d', 'dd'].includes(f[d])
              ...
              : ['yy', 'yyyy'].includes(f[d])
              ? ((h = parseInt(e[d], 10)), f[d] === 'yy' && (h += 2e3))
              : ['h', 'hh', 'H', 'HH'].includes(f[d])
              ? (k = parseInt(e[d], 10))
              : ['M', 'MM'].includes(f[d]) && (l = parseInt(e[d], 10))
          g = new Date(h, i, j, k, l)
        }
      } else
        typeof a === 'number' ? (g = new Date(a)) : a instanceof Date && (g = a)
      return g
    },
    formatDate(a, b, c) {
      let d
      ...
      let f = ''
      const g = b.split(/[\s,-\.\/\/\:]+/)
      let h = b.split(/s+|M+|H+|h+|t+|T+|d+|m+|y+/)
    ...
    center(a) {
      const b = $(window).width() / 2 - a.width() / 2
      const c = $(window).height() / 2 - a.height() / 2
    ...
    setChildPosition(a, b) {
      const c = a.getBoundingClientRect()
      const d = gj.core.height(a, !0)
      const e = gj.core.height(b, !0)
      const f = gj.core.width(a, !0)
      const g = gj.core.width(b, !0)
      const h = window.scrollY || window.pageYOffset || 0
      const i = window.scrollX || window.pageXOffset || 0
    ...
    setCaretAtEnd(a) {
      ...
      if (a)
        if (((b = a.value.length), document.selection)) {
          a.focus()
          const c = document.selection.createRange()
          c.moveStart('character', -b),
            c.moveStart('character', b),
            c.moveEnd('character', 0),
            c.select()
        } else
          (a.selectionStart || a.selectionStart == '0') &&
  ...
  (gj.picker.methods = {
    initialize(a, b, c) {
      let d
      const e = c.createPicker(a, b)
      let f = a.parent('div[role="wrapper"]')
      ;(d =
        b.uiLibrary === 'bootstrap'
          ? $(
        ...
        b.uiLibrary === 'bootstrap' || b.uiLibrary === 'bootstrap4'
          ? b.size === 'small'
  ...
  (gj.dialog.methods = {
    ...
    getHTMLConfig() {
      const a = gj.widget.prototype.getHTMLConfig.call(this)
      const b = this[0].attributes
    ...
    renderHeader(a) {
      ...
      return (
        ...
        b.length === 0 && ((b = $('<div data-role="header" />')), a.prepend(b)),
        ...
        d.length === 0 && e.closeButtonInHeader
          ? ((d = $(
    ...
    content(a, b) {
      const c = a.children('div[data-role="body"]')
  ...
  (gj.dialog.widget = function (a, b) {
    ...
    return (
      ...
      $.extend(a, c),
      a.attr('data-type') !== 'dialog' && d.init.call(a, b),
      a
    )
  }),
  ...
  (gj.draggable.methods = {
    ...
    getHandleElement(a) {
      const b = a.data('handle')
      return b && b.length ? b : a
    },
    createUpHandler(a) {
      return function (b) {
        a.attr('draggable-dragging') === 'true' &&
  ...
  (gj.draggable.widget = function (a, b) {
    ...
    return (
      ...
      $.extend(a, c),
      a.attr('data-draggable') !== 'true' && d.init.call(a, b),
      a
    )
  }),
  ...
  (gj.droppable.methods = {
    ...
    createMouseDownHandler(a) {
      return function (b) {
        a.isDragging = !0
      }
    },
    createMouseMoveHandler(a) {
      return function (b) {
        if (a.isDragging) {
          const c = a.data('hoverClass')
          const d = { x: a.mouseX(b), y: a.mouseY(b) }
          const e = gj.droppable.methods.isOver(a, d)
          e != a.isOver &&
            (e
    ...
    createMouseUpHandler(a) {
      return function (b) {
        const c = { left: a.mouseX(b), top: a.mouseY(b) }
        ;(a.isDragging = !1),
          gj.droppable.methods.isOver(a, c) && gj.droppable.events.drop(a)
      }
    },
    isOver(a, b) {
      const c = a.offset().top
      const d = a.offset().left
      return (
        b.x > d &&
  ...
  (gj.droppable.widget = function (a, b) {
    ...
    return (
      ...
      $.extend(a, c),
      a.attr('data-droppable') !== 'true' && d.init.call(a, b),
      a
    )
  }),
  ...
  (gj.grid.events = {
    ...
    rowDataBound(a, b, c, d) {
      return a.triggerHandler('rowDataBound', [b, c, d])
    },
    cellDataBound(a, b, c, d, e) {
  ...
  (gj.grid.methods = {
    ...
    getConfig(a, b) {
      const c = gj.widget.prototype.getConfig.call(this, a, b)
      return (
    ...
    getHTMLConfig() {
      ...
      return (
        ...
        this.find('thead > tr > th').each(function () {
          const b = $(this)
          const c = b.text()
          const d = gj.widget.prototype.getHTMLConfig.call(b)
          ;(d.title = c),
            d.field || (d.field = c),
    ...
    initialize(a) {
      const b = a.data()
      let c = a.parent('div[data-role="wrapper"]')
      gj.grid.methods.localization(b),
        ...
        b.fontSize && a.css('font-size', b.fontSize),
        b.headerRowHeight === 'autogrow' && a.addClass('autogrow-header-row'),
        b.bodyRowHeight === 'fixed' && a.addClass('fixed-body-rows'),
        a.addClass(b.style.table),
        b.selectionMethod === 'checkbox' &&
        ...
        a.children('tbody').length === 0 && a.append($('<tbody/>')),
    ...
    renderHeader(a) {
      ...
      for (
        b = a.data(),
          ...
          d = b.style.header,
          e = a.children('thead'),
          e.length === 0 && ((e = $('<thead />')), a.prepend(e)),
    ...
    createSortHandler(a, b) {
      return function () {
        ...
        a.count() > 0 &&
          ...
          (b.direction = b.direction === 'asc' ? 'desc' : 'asc'),
    ...
    updateHeader(a) {
      ...
      let c
      const d = a.data()
      const e = d.params[d.paramNames.sortBy]
      const f = d.params[d.paramNames.direction]
      a.find('thead tr th [data-role="sorticon"]').remove(),
        e &&
          ...
          position > -1 &&
            ...
            ).append(f === 'desc' ? d.icons.desc : d.icons.asc)),
            c.after(b)))
    },
    useHtmlDataSource(a, b) {
      let c
      let d
      let e
      let f
      const g = []
      const h = a.find('tbody tr[data-role != "empty"]')
    ...
    loadData(a) {
      ...
      for (
        b = a.data(),
          ...
          e === 0 && (g.empty(), gj.grid.methods.appendEmptyRow(a)),
          h = g.children('tr'),
          f = h.length,
          d = 0;
        d < f;
    ...
    createCellEventHandler(a, b) {
      return function (c) {
        a.stopPropagation && c.stopPropagation(), b.call(this, c)
      }
    },
    renderDisplayElement(a, b, c, d, e, f) {
      let g, h
      c.type === 'checkbox' && gj.checkbox
        ? f === 'create'
        ...
        ? ((g = c.tmpl),
          ...
          b.html(g))
        : c.renderer && typeof c.renderer === 'function'
        ...
        : ((d[c.field] = gj.grid.methods.formatText(d[c.field], c)),
          ...
          b.html(d[c.field])),
        c.tooltip && f === 'create' && b.attr('title', c.tooltip)
    },
    formatText(a, b) {
      return (
        (a =
          a && ['date', 'time', 'datetime'].includes(b.type)
      ...
      return (
        ...
        c &&
          (c.attr('data-selected') === 'true'
            ...
            : (d.selectionType === 'single' &&
                c.siblings('[data-selected="true"]').each(function () {
                  const b = $(this)
                  const c = gj.grid.methods.getId(
                    b,
                    d.primaryKey,
                    b.data('position')
                  )
    ...
    selectAll(a) {
      ...
      return (
        a.find('tbody tr[data-role="row"]').each(function () {
          const c = $(this)
          const d = c.data('position')
          const e = a.get(d)
          const f = gj.grid.methods.getId(e, b.primaryKey, d)
    ...
    getSelections(a) {
      ...
      const d = []
      const e = a.data()
      const f = gj.grid.methods.getSelectedRows(a)
      return (
        f.length > 0 &&
          f.each(function () {
    ...
    getById(a, b) {
      let c
      let d = null
      const e = a.data('primaryKey')
      const f = a.data('records')
      if (e) {
    ...
    setCellContent(a, b, c, d) {
      let e
      const f = gj.grid.methods.getCell(a, b, c)
      f &&
        (f.empty(),
        typeof d === 'object'
          ? f.append(d)
      ...
      for (b in d.params)
        d.params[b] &&
          ...
          (e = $.grep(e, function (a) {
            const e = a[b] || ''
            const f = d.params[b] || ''
            return c && typeof c.filter === 'function'
              ? c.filter(e, f)
              : e.toUpperCase().includes(f.toUpperCase())
          })))
      return gj.grid.events.dataFiltered(a, e), e
    },
    createDefaultSorter(a, b) {
      return function (c, d) {
        const e = (c[b] || '').toString()
        const f = (d[b] || '').toString()
        return a === 'asc' ? e.localeCompare(f) : f.localeCompare(e)
      }
    },
    destroy(a, b, c) {
      return (
    ...
    showColumn(a, b) {
      let c
      const d = a.data()
      const e = gj.grid.methods.getColumnPosition(d.columns, b)
      return (
        e > -1 &&
    ...
    addRow(a, b) {
      ...
      return (
        ...
        c.totalRecords === 1 && a.children('tbody').empty(),
    ...
    updateRow(a, b, c) {
      let d
      const e = gj.grid.methods.getRowById(a, b)
      const f = a.data()
      return (
    ...
    getColumnPositionByRole(a, b) {
      let c
      let d
      const e = a.data('columns')
    ...
    getColumnPositionNotInRole(a) {
      let b
      let c = 0
      const d = a.data('columns')
  ...
  (gj.grid.widget = function (a, b) {
    ...
    return (
      ...
      $.extend(a, c),
      a.attr('data-type') !== 'grid' && d.init.call(a, b),
      a
    )
  }),
  ...
  (gj.grid.plugins.fixedHeader = {
    ...
    private: {
      init(a) {
        const b = a.data()
        const c = a.children('tbody')
        const d = a.children('thead')
        const e =
          b.height - d.outerHeight() - (a.children('tfoot').outerHeight() || 0)
      ...
      refresh(a) {
        let b
        let c
        const d = (a.data(), a.children('tbody'))
        const e = a.children('thead')
        const f = a.find('tbody tr[data-role="row"] td')
        const g = a.find('thead tr[data-role="caption"] th')
        for (
  ...
  (gj.grid.plugins.expandCollapseRows = {
    ...
    private: {
      expandDetail(a, b, c) {
        const d = b.closest('tr')
        const e = $('<tr data-role="details" />')
        const f = $(
          '<td colspan="' + gj.grid.methods.countVisibleColumns(a) + '" />'
        )
        const g = $('<div data-role="display" />')
        const h = a.data()
        const i = d.data('position')
        const j = a.get(i)
        const k = gj.grid.plugins.expandCollapseRows
      ...
      collapseDetail(a, b, c) {
        const d = b.closest('tr')
        const e = d.next('tr[data-role="details"]')
        const f = a.data()
        const g = gj.grid.plugins.expandCollapseRows
        void 0 === typeof c &&
      ...
      keepSelection(a, b) {
        ...
        c.keepExpandedRows &&
          ($.isArray(c.expandedRows)
            ? !c.expandedRows.includes(b) && c.expandedRows.push(b)
            : (c.expandedRows = [b]))
      },
      removeSelection(a, b) {
        const c = a.data()
        c.keepExpandedRows &&
          $.isArray(c.expandedRows) &&
          c.expandedRows.includes(b) &&
          c.expandedRows.splice(c.expandedRows.indexOf(b), 1)
      },
      updateDetailsColSpan(a) {
        const b = a.find('tbody > tr[data-role="details"] > td')
        b &&
          b.length &&
    ...
    public: {
      ...
      updateDetails(a) {
        const b = this
        const c = a.data('details')
        let d = c.html()
        const e = b.get(a.data('position'))
        return (
          e &&
            d &&
            (c.html().replace(/\{(.+?)\}/g, function (a, c) {
              const f = gj.grid.methods.getColumnInfo(b, c)
        ...
        void 0 !== c.detailTemplate &&
          ((b = {
            ...
            events: {
              click(b) {
                const c = $(this)
                const d = gj.grid.plugins.expandCollapseRows.private
                c.closest('tr').next().attr('data-role') === 'details'
  ...
  (gj.grid.plugins.inlineEditing = {
    renderers: {
      editManager(a, b, c, d, e, f) {
        const g = f.data()
        const h = $(g.inlineEditing.editButton).attr('key', e)
        const i = $(g.inlineEditing.deleteButton).attr('key', e)
        const j = $(g.inlineEditing.updateButton).attr('key', e).hide()
        const k = $(g.inlineEditing.cancelButton).attr('key', e).hide()
  ...
  (gj.grid.plugins.inlineEditing.private = {
        ...
        if (c.editor) {
          if (
            ...
            if (typeof c.editor === 'function')
              ...
              ((i = typeof c.editor === 'object' ? c.editor : {}),
              ...
              (c.type === 'date' && gj.datepicker) ||
              (c.type === 'time' && gj.timepicker) ||
              (c.type === 'datetime' && gj.datetimepicker)
            ) {
              switch (
    ...
    displayMode(a, b, c, d) {
      ...
      c.mode !== 'editOnly' &&
        (b.attr('data-mode') === 'edit' &&
          ...
          g[0].tagName.toUpperCase() === 'SELECT' && g[0].selectedIndex > -1
            ? ((h = g[0].options[g[0].selectedIndex].innerHTML),
              (i = g[0].value))
            : (h =
                g[0].tagName.toUpperCase() === 'INPUT' &&
                g[0].type.toUpperCase() === 'CHECKBOX'
                  ? g[0].checked
                  : g.val()),
          ...
          !0 !== d &&
            h !== j[c.field] &&
            ((j[c.field] =
              c.type === 'date' ? gj.core.parseDate(h, c.format) : h),
    ...
    updateOtherCells(a, b) {
      const c = a.data()
      c.inlineEditing.mode !== 'command' &&
        b !== 'editOnly' &&
        a
  ...
  (gj.grid.plugins.inlineEditing.public = {
    ...
    edit(a) {
      let b
      const c = this.getById(a)
      const d = gj.grid.methods.getRowById(this, a).children('td')
      const e = this.data('columns')
      for (b = 0; b < d.length; b++)
  ...
  (gj.grid.plugins.inlineEditing.events = {
    cellDataChanged(a, b, c, d, e, f) {
      a.triggerHandler('cellDataChanged', [b, c, d, e, f])
    },
    rowDataChanged(a, b, c) {
  ...
  (gj.grid.plugins.pagination = {
    ...
    private: {
      ...
      localizationBootstrap(a) {
        const b = gj.grid.messages[a.locale]
      ...
      initPagerControl(a, b) {
        const c = b.data()
        switch (a.data('role')) {
          case 'page-size':
            c.pager.sizes && c.pager.sizes.length > 0
              ? (a.show(),
                ...
                a.change(function () {
                  const a = parseInt(this.value, 10)
      ...
      reloadPager(a, b) {
        ...
        if (((h = a.data()), h.pager)) {
          for (
            c = b === 0 ? 0 : parseInt(h.params[h.paramNames.page], 10),
      ...
      reloadPagerControl(a, b, c, d, e, f, g) {
        let h
        switch (a.data('role')) {
          case 'page-first':
      ...
      assignPageHandler(a, b, c, d) {
        const e = a.data().style.pager
        d
      ...
      assignButtonHandler(a, b, c, d, e) {
        const f = a.data().style.pager
        d < 1 || d > e
          ? b.hide()
      ...
      createChangePageHandler(a, b) {
        return function () {
          const b = (a.data(), parseInt(this.value, 10))
      ...
      updatePagerColSpan(a) {
        const b = a.find('tfoot > tr[data-role="pager"] > th')
        b &&
          b.length &&
          b.attr('colspan', gj.grid.methods.countVisibleColumns(a))
      },
      isLastRecordVisible(a) {
        let b = !0
        const c = a.data()
        const d = parseInt(c.params[c.paramNames.limit], 10)
        const e = parseInt(c.params[c.paramNames.page], 10)
        const f = a.count()
  ...
  (gj.grid.plugins.responsiveDesign = {
    ...
    public: {
      ...
      makeResponsive() {
        ...
        let c = 0
        const d = this.data()
        const e = gj.grid.plugins.responsiveDesign.private.orderColumns(d)
    ...
    private: {
      ...
      createResizeHandle(a, b, c) {
        ...
        return function (e, f) {
          ...
          let k
          let l
          let m = parseInt(b.attr('width'), 10)
          const n = gj.core.position(this)
          const o = { top: f.top - n.top, left: f.left - n.left }
          if (
            (m || (m = b.outerWidth()),
            o.left &&
              ((k = m + o.left),
  ...
  (gj.grid.plugins.rowReorder = {
    ...
    private: {
      init(a) {
        ...
        let c
        let d
        const e = a.find('tbody tr[data-role="row"]')
        for (
      ...
      createRowMouseDownHandler(a, b) {
        return function (c) {
          let d
          let e
          const f = a.clone()
          const g = a.data('columns')
          for (
            a.addClass('gj-unselectable'),
              $('body').append(f),
          ...
          f.draggable({
            ...
            b.attr('data-droppable') === 'true' && b.droppable('destroy'),
            b.siblings('tr[data-role="row"]').each(function () {
              const a = $(this)
              a.attr('data-droppable') === 'true' && a.droppable('destroy'),
                a.droppable({
        ...
        return function (c, d) {
          $('table[data-role="draggable-clone"]').draggable('destroy').remove(),
            ...
            b.siblings('tr[data-role="row"]').each(function () {
              ...
              let h
              const i = $(this)
              const j = i.data('position')
              const k = b.data('position')
              const l = a.data()
  ...
  (gj.grid.plugins.export = {
    ...
    public: {
      getCSV(a) {
        ...
        let d = ''
        let e = ''
        const f = this.data().columns
        const g = this.getAll(a)
        if (g.length) {
  ...
  (gj.grid.plugins.columnReorder = {
    ...
    private: {
        ...
        return function (c) {
          ...
          a.data('dragReady') &&
            ...
            b.siblings('th').each(function () {
              const c = $(this)
              c.attr('data-droppable') === 'true' && c.droppable('destroy'),
                c.droppable({
        ...
        return function (c, d) {
          $('table[data-role="draggable-clone"]').draggable('destroy').remove(),
            ...
            b.siblings('th').each(function () {
              const c = $(this)
              const e = a.data()
              const f = gj.grid.methods.getColumnPosition(
                e.columns,
                c.data('field')
              )
              const g = gj.grid.methods.getColumnPosition(
                e.columns,
                b.data('field')
              )
              c
      ...
      moveRowCells(a, b, c) {
        let d
        let e
        const f = a.find('tbody tr[data-role="row"]')
      ...
      createDroppableOverHandler(a, b) {
        return function (c) {
          const d = $(this)
          const e = a.data()
  ...
  (gj.grid.plugins.grouping = {
    ...
    private: {
      init(a) {
        ...
        ;(b = void 0),
          a.on('rowDataBound', function (d, e, f, g) {
            if (b !== g[c.grouping.groupBy] || e[0].rowIndex === 1) {
              const h = gj.grid.methods.countVisibleColumns(a) - 1
              const i = $('<tr role="group" />')
              const j = $(
      ...
      createExpandCollapseHandler(a) {
        return function (b) {
          const c = $(this)
          const d = gj.grid.plugins.grouping.private
          c.closest('tr').next(':visible').data('role') === 'row'
            ? d.collapseGroup(a, c)
            : d.expandGroup(a, c)
        }
      },
      collapseGroup(a, b) {
        const c = b.children('div[data-role="display"]')
  ...
  (gj.tree.methods = {
    ...
    loadData(a) {
      let b
      const c = a.data('records')
      const d = a.children('ul')
      for (
    ...
    appendNode(a, b, c, d, e) {
      ...
      let j
      const k = a.data()
      const l = k.primaryKey ? c[k.primaryKey] : c[k.autoGenFieldName]
      if (
        ...
        (hasChildren =
          ...
          c[k.hasChildrenField].toString().toLowerCase() === 'true'),
        (disabled =
          void 0 !== c[k.disabledField] &&
          c[k.disabledField].toString().toLowerCase() === 'true'),
        k.indentation &&
          $wrapper.append(
    ...
    expanderClickHandler(a) {
      return function (b) {
        const c = $(this)
        const d = c.closest('li')
        c.attr('data-mode') === 'close' ? a.expand(d) : a.collapse(d)
      }
    },
    expand(a, b, c) {
      let d
      let e
      const f = b.find('>[data-role="wrapper"]>[data-role="expander"]')
      const g = a.data()
      const h = b.attr('data-id')
      const i = b.children('ul')
      if (
    ...
    displayClickHandler(a) {
      return function (b) {
        const c = $(this)
        const d = c.closest('li')
        const e = a.data().cascadeSelection
        d.attr('data-selected') === 'true'
          ? gj.tree.methods.unselect(a, d, e)
          : (a.data('selectionType') === 'single' &&
    ...
    addNode(a, b, c, d) {
      ...
      return (
        c && c.length
          ? (c[0].tagName.toLowerCase() === 'li' &&
              (c.children('ul').length === 0 &&
                (c
    ...
    enableNode(a, b, c) {
      ...
      let e
      const f = b.find('>[data-role="wrapper"]>[data-role="expander"]')
      const g = b.find('>[data-role="wrapper"]>[data-role="display"]')
      var c = void 0 === c || c
      if (
  ...
  (gj.tree.widget = function (a, b) {
    ...
    return (
      ...
      $.extend(a, c),
      a.attr('data-type') !== 'tree' && d.init.call(a, b),
      a
    )
  }),
  ...
  (gj.tree.plugins.checkboxes = {
      ...
      nodeDataBound(a, b, c, d) {
        ...
        b.find('> [data-role="wrapper"] > [data-role="checkbox"]').length ===
          ...
          (i =
            ...
            d[e.disabledField].toString().toLowerCase() === 'true'),
          (g = g.checkbox({
    ...
    public: {
      getCheckedNodes() {
        const a = []
        const b = this.find('li [data-role="checkbox"] input[type="checkbox"]')
        return (
          $.each(b, function () {
            const b = $(this)
            b.checkbox('state') === 'checked' &&
      ...
      checkAll() {
        const a = this.find('li [data-role="checkbox"] input[type="checkbox"]')
        return (
          $.each(a, function () {
  ...
  (gj.tree.plugins.dragAndDrop = {
    ...
    private: {
      nodeDataBound(a, b) {
        const c = b.children('[data-role="wrapper"]')
        const d = b.find('>[data-role="wrapper"]>[data-role="display"]')
        c.length &&
          d.length &&
          (d.on(
            'mousedown',
      ...
      createNodeMouseDownHandler(a) {
        return function (b) {
          a.data('dragReady', !0)
        }
      },
      createNodeMouseUpHandler(a) {
        return function (b) {
          a.data('dragReady', !1)
        }
      },
      createNodeMouseMoveHandler(a, b, c) {
        return function (d) {
          if (a.data('dragReady')) {
            let e
            let f
      ...
      getTargetWrappers(a, b) {
        return a
          .find('[data-role="wrapper"]')
          .not(b.find('[data-role="wrapper"]'))
      },
      createDragHandler(a, b, c) {
        const d = gj.tree.plugins.dragAndDrop.private.getTargetDisplays(a, b, c)
        const e = gj.tree.plugins.dragAndDrop.private.getTargetWrappers(a, b)
        const f = a.data()
      ...
      refreshNode(a, b) {
        const c = b.children('[data-role="wrapper"]')
        const d = c.children('[data-role="expander"]')
        const e = c.children('[data-role="spacer"]')
        const f = b.children('ul')
        const g = a.data()
        const h = b.parentsUntil('[data-type="tree"]', 'ul').length
    ...
    private: {
      ...
      createDoneHandler(a, b) {
        return function (c) {
          ...
          const g = a.data()
          if (
            (typeof c === 'string' && JSON && (c = JSON.parse(c)),
            c && c.length)
          ) {
            for (
              f = b.children('ul'),
      ...
      expand(a, b, c) {
        ...
        const e = a.data()
        const f = {}
        const g = b.find('>ul>li')
        ;(g && g.length) ||
          (typeof e.dataSource === 'string' &&
  ...
  (gj.checkbox.methods = {
    ...
    toggle(a) {
      return (
        a.state() == 'checked' ? a.state('unchecked') : a.state('checked'), a
      )
    },
    destroy(a) {
      return (
        a.attr('data-checkbox') === 'true' &&
          (a.removeData(),
          a.removeAttr('data-guid'),
  ...
  (gj.checkbox.widget = function (a, b) {
    ...
    return (
      ...
      $.extend(a, c),
      a.attr('data-checkbox') !== 'true' && d.init.call(a, b),
      a
    )
  }),
  ...
  (gj.editor.methods = {
    ...
    initialize(a) {
      ...
      if (
        (a.hide(),
        a[0].parentElement.attributes.role !== 'wrapper' &&
        ...
        e.length === 0 &&
          ((e = $('<div role="body"></div>')),
          $(d).append(e),
          a[0].textContent && (e[0].innerHTML = a[0].textContent)),
        e.attr('contenteditable', !0),
        e.on('keydown', function (b) {
          const c = event.keyCode || event.charCode
        ...
        for (const i in h.buttons) {
          b = $('<div />').addClass(h.style.buttonsGroup)
          for (const j in h.buttons[i])
            (c = $(h.buttons[i][j])),
              c.on('click', function () {
    ...
    localization(a) {
      const b = gj.editor.messages[a.locale]
      void 0 === a.buttons &&
        (a.buttons = [
          [
    ...
    updateToolbar(a, b) {
      ...
      $buttons = b.find('[role]').each(function () {
        ...
        document.queryCommandValue(b) === 'true'
    ...
    content(a, b) {
      const c = a.parent().children('div[role="body"]')
      return void 0 === b ? c.html() : c.html(b)
    },
    destroy(a) {
      let b
      return (
        a.attr('data-editor') === 'true' &&
          ((b = a.parent()),
  ...
  (gj.editor.widget = function (a, b) {
    ...
    return (
      ...
      $.extend(a, c),
      a.attr('data-editor') !== 'true' && d.init.call(a, b),
      a
    )
  }),
  ...
  (gj.dropdown.methods = {
    ...
    initialize(a) {
      const b = a.data()
      let c = a.parent('div[role="wrapper"]')
      const d = $('<span role="display"></span>')
      const e = $(
        '<span role="expander">' + b.icons.dropdown + '</span>'
      ).addClass(b.style.expander)
      const f = $('<button role="presenter" type="button"></button>').addClass(
        b.style.presenter
      )
      const g = $('<ul role="list" class="' + b.style.list + '"></ul>').attr(
        'guid',
        a.attr('data-guid')
      )
      c.length === 0
    ...
    setListPosition(a, b, c) {
      let d
      let e
      let f
      let g
      const h = a.getBoundingClientRect()
      const i = window.scrollY || window.pageYOffset || 0
    ...
    filter(a) {
      ...
      const d = a.data()
      if (d.dataSource) {
        if (typeof d.dataSource[0] === 'string')
    ...
    render(a, b) {
      ...
      const d = a.data()
      const e = a.parent()
      const f = $('body').children(
        '[role="list"][guid="' + a.attr('data-guid') + '"]'
      )
      const g = e.children('[role="presenter"]')
      const h =
      ...
      if ((a.data('records', b), a.empty(), f.empty(), b && b.length))
        if (
          ($.each(b, function () {
            let b
            const e = this[d.valueField]
            const g = this[d.textField]
            const h =
              this[d.selectedField] &&
              this[d.selectedField].toString().toLowerCase() === 'true'
            ;(b = $(
              '<li value="' +
                e +
    ...
    open(a, b) {
      const c = a.data()
      const d = a.parent().find('[role="expander"]')
      const e = a.parent().find('[role="presenter"]')
      const f = gj.core.getScrollParent(a[0])
    ...
    close(a, b) {
      const c = a.data()
      const d = a.parent().find('[role="expander"]')
      const e = gj.core.getScrollParent(a[0])
    ...
    addParentsScrollListener(a, b) {
      const c = gj.core.getScrollParent(a.parentNode)
      a.addEventListener('scroll', b),
        c && gj.dropdown.methods.addParentsScrollListener(c, b)
    },
    removeParentsScrollListener(a, b) {
      const c = gj.core.getScrollParent(a.parentNode)
    ...
    select(a, b) {
      const c = a.data()
      const d = $('body').children(
        '[role="list"][guid="' + a.attr('data-guid') + '"]'
      )
      const e = d.children('li[value="' + b + '"]')
      const f = a.next('[role="presenter"]').find('[role="display"]')
      const g = gj.dropdown.methods.getRecordByValue(a, b)
      return (
    ...
    destroy(a) {
      const b = a.data()
      const c = a.parent('div[role="wrapper"]')
      return (
        b &&
          (a.xhr && a.xhr.abort(),
          a.off(),
  ...
  (gj.dropdown.widget = function (a, b) {
    ...
    return (
      ...
      $.extend(a, c),
      a.attr('data-dropdown') !== 'true' && d.init.call(a, b),
      a
    )
  }),
  ...
  (gj.datepicker.methods = {
    ...
    initialize(a, b) {
      let c
      let d
      let e = a.parent('div[role="wrapper"]')
      e.length === 0
    ...
    createCalendar(a, b) {
      ...
      let f
      let g
      const h = $('<div role="calendar" type="month"/>')
    ...
    renderMonth(a, b, c) {
      ...
      let q
      let r
      const s = b.children('[role="body"]')
      const t = $('<table/>')
      const u = $('<tbody/>')
      let v = gj.core.messages[c.locale].titleFormat
      for (
        s.off().empty(),
      ...
      for (l > 1 && u.append($row), m = new Date(), l = 1; l <= j; l++)
        (r = new Date(h, g, l)),
          ...
          p.append(q),
          $row.append(p),
          ++d == 7 && (u.append($row), (d = 0))
      for (o = gj.datepicker.methods.getNextMonth(g, h), l = 1; d != 0; l++)
    ...
    renderYear(a, b, c) {
      ...
      let f
      let g
      const h = b.find('>[role="body"]>table')
      const i = h.children('tbody')
      for (
    ...
    renderDecade(a, b, c) {
      ...
      let g
      let h
      const i = b.find('>[role="body"]>table')
      const j = i.children('tbody')
      for (
    ...
    getWeekNumber(a) {
      ...
      const c = new Date(Date.UTC(b.getUTCFullYear(), 0, 1))
    ...
    getMinDate(a) {
      ...
      return (
        a.minDate &&
          (typeof a.minDate === 'string'
            ? (b = gj.core.parseDate(a.minDate, a.format, a.locale))
            : typeof a.minDate === 'function'
            ? typeof (b = a.minDate()) === 'string' &&
              (b = gj.core.parseDate(b, a.format, a.locale))
            : typeof a.minDate.getMonth === 'function' && (b = a.minDate)),
        b
      )
    },
    getMaxDate(a) {
      ...
      return (
        a.maxDate &&
          (typeof a.maxDate === 'string'
            ? (b = gj.core.parseDate(a.maxDate, a.format, a.locale))
            : typeof a.maxDate === 'function'
            ? typeof (b = a.maxDate()) === 'string' &&
              (b = gj.core.parseDate(b, a.format, a.locale))
            : typeof a.maxDate.getMonth === 'function' && (b = a.maxDate)),
        b
      )
    },
    isSelectable(a, b) {
      let c
      let d = !0
      const e = gj.datepicker.methods.getMinDate(a)
      const f = gj.datepicker.methods.getMaxDate(a)
      if ((e && b < e ? (d = !1) : f && b > f && (d = !1), d)) {
          ...
          if ($.isArray(a.disableDates))
            for (c = 0; c < a.disableDates.length; c++)
              ...
              a.disableDates[c].getTime() === b.getTime()
                ? (d = !1)
                : typeof a.disableDates[c] === 'string' &&
                  gj.core
        ...
        $.isArray(a.disableDaysOfWeek) &&
          a.disableDaysOfWeek.includes(b.getDay()) &&
          (d = !1)
      }
      return d
    },
    ...
    change(a, b, c, d) {
      const e = (d.getDate(), d.getMonth())
      const f = d.getFullYear()
      const g = gj.core.formatDate(d, c.format, c.locale)
      b.attr('month', e),
        b.attr('year', f),
        a.val(g),
        gj.datepicker.events.change(a),
        window.getComputedStyle(b[0]).display !== 'none' &&
          gj.datepicker.methods.close(a)
    },
    selectDay(a, b, c, d) {
      const e = d.getDate()
      ...
      return function (d) {
        ...
        window.getComputedStyle(b[0]).display !== 'none' &&
          ...
          d.keyCode == '38'
            ...
            : d.keyCode == '27' && a.close())
      }
    },
    getActiveCell(a) {
      let b = a.find('td[day].focused')
      return (
        b.length === 0 &&
          ((b = a.find('td[day].selected')),
          b.length === 0 &&
            ((b = a.find('td[day].today')),
            b.length === 0 && (b = a.find('td[day]:not(.disabled)').first()))),
        b
      )
    },
    value(a, b) {
  ...
  (gj.datepicker.widget = function (a, b) {
    ...
    return (
      ...
      $.extend(a, c),
      a.attr('data-datepicker') !== 'true' && d.init.call(a, b),
      a
    )
  }),
  ...
  (gj.timepicker.methods = {
    ...
    createPicker(a) {
      let b
      const c = a.data()
      const d = $('<div role="picker" />')
        .addClass(c.style.clock)
        .attr('guid', a.attr('data-guid'))
      const e = $('<div role="hour" />')
      const f = $('<div role="minute" />')
      const g = $('<div role="header" />')
      const h = $('<div role="mode" />')
      const i = $('<div role="body" />')
      const j = $(
        '<button class="' +
          c.style.button +
          '">' +
      ...
      const l = $('<div role="footer" class="' + c.style.footer + '" />')
      return (
          ...
          c.mode === 'ampm' &&
            (h.append(
              $(
                ...
                const b = gj.timepicker.methods.getHour(d)
                d.attr('mode', 'am'),
    ...
    setTime(a, b) {
      return function () {
        const c = gj.timepicker.methods.getHour(b)
        const d = gj.timepicker.methods.getMinute(b)
        const e = b.attr('mode')
        const f = new Date(0, 0, 0, c === 12 && e === 'am' ? 0 : c, d)
        const g = a.data()
        const h = gj.core.formatDate(f, g.format, g.locale)
        a.value(h), a.close()
      }
    },
    getPointerValue(a, b, c) {
      let d
      let e
      const f = 256
      let g = (Math.atan2(f / 2 - a, f / 2 - b) / Math.PI) * 180
      switch ((g < 0 && (g = 360 + g), c)) {
        case 'ampm':
          return (d = 12 - Math.round((12 * g) / 360)), d === 0 ? 12 : d
        case '24hr':
          return (
            (e = Math.sqrt(Math.pow(f / 2 - a, 2) + Math.pow(f / 2 - b, 2))),
            (d = 12 - Math.round((12 * g) / 360)),
            d === 0 && (d = 12),
            e < f / 2 - 32 && (d = d === 12 ? 0 : d + 12),
            d
          )
        case 'minutes':
          return (d = Math.round(60 - (60 * g) / 360)), d === 60 ? 0 : d
      }
    },
    updateArrow(a, b, c, d) {
      let e
      ...
      const h = b.mouseY(a)
      const i = window.scrollY || window.pageYOffset || 0
      const j = window.scrollX || window.pageXOffset || 0
      ;(e = a.target.getBoundingClientRect()),
        d.dialMode == 'hours'
          ? ((f = gj.timepicker.methods.getPointerValue(
            ...
            c.attr(
              'hour',
              d.mode === 'ampm' && c.attr('mode') === 'pm' && f < 12
                ? f + 12
                : f
            ))
          : d.dialMode == 'minutes' &&
    ...
    update(a, b, c) {
      ...
      ;(d = gj.timepicker.methods.getHour(b)),
        ...
        (f = b.find('[role="arrow"]')),
        c.dialMode == 'hours' && (d == 0 || d > 12) && c.mode === '24hr'
        ...
        f.show(),
        (g = c.mode === 'ampm' && d > 12 ? d - 12 : d == 0 ? 12 : d),
        (i = b.find('[role="body"] span')),
        i.removeClass('selected'),
        i
          .filter(function (a) {
            return c.dialMode == 'hours'
    ...
    mouseDownHandler(a, b) {
      return function (b) {
        a.mouseMove = !0
      }
    },
    mouseMoveHandler(a, b, c) {
      return function (d) {
        a.mouseMove && gj.timepicker.methods.updateArrow(d, a, b, c)
      }
    },
    mouseUpHandler(a, b, c) {
      return function (d) {
    ...
    open(a) {
      ...
      return (
        (b = a.value()
          ...
          : new Date()),
        (c = b.getHours()),
        d.mode === 'ampm' && e.attr('mode', c > 12 ? 'pm' : 'am'),
        e.attr('hour', c),
  ...
  (gj.timepicker.widget = function (a, b) {
    ...
    return (
      ...
      $.extend(a, c),
      a.attr('data-timepicker') !== 'true' && d.init.call(a, b),
      a
    )
  }),
  ...
  (gj.datetimepicker.methods = {
    ...
    initialize(a) {
      ...
      ;(j.datepicker.uiLibrary = j.uiLibrary),
        ...
        a.on('open', function () {
          const a = b.children('[role="header"]')
    ...
    createShowDateHandler(a, b, c) {
      return function (d) {
        const e = b.children('[role="header"]')
    ...
    createShowHourHandler(a, b, c) {
      return function () {
        const d = b.children('[role="header"]')
        ...
        : ((d = gj.core.parseDate(b, f.format, f.locale)),
          d
            ? ((c = $('body').find(
              ...
              (e = d.getHours()),
              f.mode === 'ampm' && c.attr('mode', e > 12 ? 'pm' : 'am'),
              c.attr('hour', e),
  ...
  (gj.datetimepicker.widget = function (a, b) {
    const c = this
    const d = gj.datetimepicker.methods
    return (
      (c.mouseMove = !1),
      (c.value = function (a) {
        return d.value(this, a)
      ...
      $.extend(a, c),
      a.attr('data-datetimepicker') !== 'true' && d.init.call(a, b),
      a
    )
  }),
  ...
  (gj.slider.methods = {
    ...
    createClickHandler(a, b, c, d) {
      return function (e) {
        let f, g, h, i, j
        c.getAttribute('drag') !== 'true' &&
    ...
    createMouseUpHandler(a, b, c) {
      return function (c) {
        b.getAttribute('drag') === 'true' &&
          (b.setAttribute('drag', 'false'), gj.slider.events.change(a))
      }
    },
    createMouseDownHandler(a, b) {
      return function (b) {
        a.setAttribute('drag', 'true')
      }
    },
    createMouseMoveHandler(a, b, c, d, e) {
      return function (d) {
        let f, g, h, i, j, k, l
        c.getAttribute('drag') === 'true' &&
          ((f = gj.core.position(a[0].parentElement)),
  ...
  (gj.slider.widget = function (a, b) {
    ...
    return (
      ...
      $.extend(a, c),
      a.attr('data-slider') !== 'true' && d.init.call(a, b),
      a
    )
  }),
  ...
  (gj.colorpicker.widget = function (a, b) {
    const c = this
    const d = gj.colorpicker.methods
    return (
      (c.value = function (a) {
        return d.value(this, a)
      }),
      ...
      $.extend(a, c),
      a.attr('data-colorpicker') !== 'true' && d.init.call(a, b),
      a
    )
  }),
